...
**遷移後延伸任務（非原 CORE/MOD 盤點，Godot 端刻意擴充）：**

- [x] TASKS/14 屬性系統擴充（2026-07-19）：新增第四主屬性 luck、裝備可加主屬性、命中/抗爆/爆傷＋三段式
  攻擊。spec 升 `BATTLE_FORMULAS.md` v4.0，設計見 `docs/design/屬性戰鬥設計.md`。**實作完成、待 John 實機驗收**；
  離線 Python 公式測試待另開任務重寫。
