...
- seed ref: `assets-source/role/main/marin/battle_seed_alpha.png`（2026-07-23 已驗收）
...
- 最後一版: 2026-07-23 `attack / dagger_thrust` 五幀 strip（HD Pixel 路線，搭配 `presets/battle_role_hd_pixel_v3.md`）；2026-07-30 再正規化為與 idle 相同的 543×724 畫布，雙腳區域錨點與腳底基準 y=659 鎖定。
